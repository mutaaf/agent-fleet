...
| 0040 | fleet self-check greps the kit's own shell for known LESSONS-documented call-shape traps | P1 | in-progress | safety |
| 0041 | fleet onboarding-check verifies a freshly-installed project is end-to-end healthy | P1 | groomed | docs |
